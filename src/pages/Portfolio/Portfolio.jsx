...
function Portfolio() {
  return (
    <>
      <Navbar />
      {/* Top content*/}
      <main className="bg-gray-50 min-h-screen px-4 py-12 md:px-16 rounded-lg">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-gray-900 text-center">
            {JsonCV.name}
          </h1>
          <h2 className="text-2xl text-gray-700 text-center">{JsonCV.title}</h2>
          <p className="text-gray-600 pt-4 pb-6">{JsonCV.profile}</p>
        </div>
        <section className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12">
          {/* Left Column: Projects & Experience */}
          <div className="md:w-2/3 flex flex-col">
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              <h3 className="text-2xl text-black font-semibold border-b-2 border-gray-200 pb-1 mb-2">
                Projects
              </h3>
